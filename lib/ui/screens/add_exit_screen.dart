...
class AddExitScreen extends GetView<AddExitController> {
  const AddExitScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppAppbar(
        ...
        subtitle: "Agregar una nueva salida al inventario",
        showBackButton: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 2.h),
              AppButton(
                onPressed: () => controller.createExit(),
