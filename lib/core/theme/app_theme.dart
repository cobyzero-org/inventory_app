...
/// A class that contains all theme configurations for the industrial adhesives application.
class AppTheme {
  AppTheme._();

  // Industrial Trust Palette - Light Theme Colors
  ...
  static const Color secondaryVariantLight = Color(0xFF356B7D);
  ...
  // Industrial Trust Palette - Dark Theme Colors
  static const Color primaryDark = Color(0xFF4A90A4);
  static const Color primaryVariantDark = Color(0xFF356B7D);
  static const Color secondaryDark = Color(0xFF1B365D);
  static const Color secondaryVariantDark = Color(0xFF0F1F3D);
  ...
  // Divider colors - Functional definition approach
  static const Color dividerLight = Color(0xFF4A90A4);
  static const Color dividerDark = Color(0xFF4A90A4);
  ...
  /// Light theme - Professional minimalism for industrial environments
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      outlineVariant: dividerLight.withValues(alpha: 0.3),
      shadow: shadowLight,
      scrim: shadowLight,
    ...
    cardColor: cardLight,
    dividerColor: dividerLight.withValues(alpha: 0.2),

    // AppBar theme - Professional header with subtle elevation
    ...
    // Card theme - Minimal elevation for content separation
    ...
    // Bottom navigation - Bottom-heavy interaction design
    ...
    // FAB theme - Context-sensitive quick actions
  ...
  /// Dark theme - High contrast for challenging environments
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      outline: dividerDark,
      outlineVariant: dividerDark.withValues(alpha: 0.3),
      shadow: shadowDark,
      scrim: shadowDark,
    ...
    cardColor: cardDark,
    dividerColor: dividerDark.withValues(alpha: 0.2),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: BorderSide(
          color: dividerDark.withValues(alpha: 0.3),
          width: 1.0,
        ),
      ),
      enabledBorder: OutlineInputBorder(
  ...
  /// Typography Standards: Inter for headings, Inter for body (replacing Source Sans Pro),
  /// Inter for captions (replacing Roboto), JetBrains Mono for data
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Label styles - Inter (replacing Roboto for captions)
  ...
  /// Data text style - JetBrains Mono for product codes, prices, specifications
